...
export default function HomePage() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-900 via-[#1a3c5e] to-[#0d2d45] flex items-center justify-center px-4">
      <div className="text-center max-w-2xl mx-auto">
        <div className="text-6xl mb-6">🎓</div>
        <h1 className="text-5xl font-bold text-white mb-4" style={{fontFamily:'Crimson Pro,serif'}}>
